    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dept', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='permission.dept', verbose_name='部门')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('job', models.ManyToManyField(db_table='user_job', to='permission.Job', verbose_name='用户和岗位关联表')),
                ('rules', models.ManyToManyField(db_table='user_rules', to='permission.Rules', verbose_name='用户和角色关联表')),
